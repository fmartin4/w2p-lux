...
'%(nrows)s records found': '%(nrows)s registros',
'%d/%m/%Y': '%d/%m/%Y',
...
'Lux': 'Lux',
'Líneas por página en tablas': 'Líneas por página en tablas',
...
'Suspender': 'Suspender',
'Suspender RAUL': 'Suspender RAUL',
'SuspenderDis': 'SuspenderDis',
'SuspenderDis2': 'SuspenderDis2',
'Table': 'tabla',
